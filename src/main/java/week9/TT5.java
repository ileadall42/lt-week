...
//        //都选左边
//        boolean win1 = dp(pl + 2, pr, cus + this.arr[pl + 1], round + 1);
////
////        //都选右边
//        boolean win2 = dp(pl, pr - 2, cus + this.arr[pr - 1], round + 1);
////
////        //alex选左，lee选右
//        boolean win3 = dp(pl + 1, pr - 1, cus + this.arr[pl + 1], round + 1);
////
////        //alex选右，lee选左
//        boolean win4 = dp(pl + 1, pr - 1, cus + this.arr[pr - 1], round + 1);
////
        //贪心，让lee每次拿小的，alex每次拿大的
        boolean finalAns = dp(pl + 2, pr, cus + this.arr[pl + 1], round + 1) ||
                dp(pl, pr - 2, cus + this.arr[pr - 1], round + 1) ||
                dp(pl + 1, pr - 1, cus + this.arr[pl + 1], round + 1) ||
                dp(pl + 1, pr - 1, cus + this.arr[pr - 1], round + 1);
//
        return finalAns;
    }
}
