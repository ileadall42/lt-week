 ...
 * 全排列 -- 有重复元素
 */
public class AllCombinationWithDuplicate {

    public static void main(String[] args) {
        int[] arr = getRandomArraySizeOf(3);
        AllCombinationWithDuplicate allCombinationWithNoDuplicate = new AllCombinationWithDuplicate();
...
//            System.out.println(curLis);
     ...
     */
    public void dfsSwapWithDuplicate(int start) {
